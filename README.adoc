...
ona li namako tawa namako ilo Poweko (nimi Powercord lon toki Inli).
ona li pana e toki pona tawa ilo Siko (nimi Discord lon toki Inli).

tan pi toki mama li ni: lipu kon {url-discord}[current.js], tan kulupu Discord-Datamining.
